...
##     uninformative NA
##------------------------------------------------------------------
processData <- function(mydt, mycols)
{
    ...
    ##------------------------------------------------------------------
    ## return the cleansed data frame
    ##------------------------------------------------------------------
    return(mydt)
}
...
train.fl    <- processData(mydt=train.dt, mycols=train.cols)
setkey(train.fl, eventid)

test.fl     <- processData(mydt=test.dt, mycols=test.cols)
setkey(test.fl, eventid)
