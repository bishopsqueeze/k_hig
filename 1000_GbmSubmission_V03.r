...
save(v03.list, v03.mat, v03.ams, file="gbm_full_depth9_trees450_shrink0.05_v03_AllScored.Rdata")
...
## output filenames
fit.id        <- "gbm_full_depth9_trees450_shrink0.05_V03_S006"
out.csv       <- paste0(fit.id,"_v03_Submission.csv")
out.rdata     <- paste0(fit.id,"_v03_Submission.Rdata")

## score -> class
thresh.S006            <- 0.820
v03.submission01.class <- ifelse(v03.submission01.mean.order >= thresh.S006, "s", "b")
v03.submission01.S006  <- data.frame(
                            EventId=v03.submission01.id.order,
                            RankOrder=v03.submission01.rank.order,
                            Class=v03.submission01.class)

## save the results
save(v03.submission01.S006, file=paste0(v03.dir,"/",out.rdata) )
write.csv(v03.submission01.S006, file=paste0(v03.dir,"/", out.csv), row.names=FALSE)
...
## output filenames
fit.id        <- "gbm_full_depth9_trees450_shrink0.05_V03_S007"
out.csv       <- paste0(fit.id,"_v03_Submission.csv")
out.rdata     <- paste0(fit.id,"_v03_Submission.Rdata")

## score -> class
thresh.S007            <- 0.8464286
v03.submission01.class <- ifelse(v03.submission01.mean.order >= thresh.S007, "s", "b")
v03.submission01.S007  <- data.frame(
EventId=v03.submission01.id.order,
RankOrder=v03.submission01.rank.order,
Class=v03.submission01.class)

## save the results
save(v03.submission01.S007, file=paste0(v03.dir,"/",out.rdata) )
write.csv(v03.submission01.S007, file=paste0(v03.dir,"/", out.csv), row.names=FALSE)
...
## output filenames
fit.id        <- "gbm_full_depth9_trees450_shrink0.05_V03_S008"
out.csv       <- paste0(fit.id,"_v03_Submission.csv")
out.rdata     <- paste0(fit.id,"_v03_Submission.Rdata")

## score -> class
thresh.S008            <- 0.860
v03.submission01.class <- ifelse(v03.submission01.mean.order >= thresh.S008, "s", "b")
v03.submission01.S008  <- data.frame(
EventId=v03.submission01.id.order,
RankOrder=v03.submission01.rank.order,
Class=v03.submission01.class)

## save the results
save(v03.submission01.S008, file=paste0(v03.dir,"/",out.rdata) )
write.csv(v03.submission01.S008, file=paste0(v03.dir,"/", out.csv), row.names=FALSE)
...
## output filenames
fit.id        <- "gbm_full_depth9_trees450_shrink0.05_V03_S009"
out.csv       <- paste0(fit.id,"_v03_Submission.csv")
out.rdata     <- paste0(fit.id,"_v03_Submission.Rdata")

## score -> class
thresh.S009            <- 0.830
v03.submission01.class <- ifelse(v03.submission01.mean.order >= thresh.S009, "s", "b")
v03.submission01.S009  <- data.frame(
EventId=v03.submission01.id.order,
RankOrder=v03.submission01.rank.order,
Class=v03.submission01.class)

## save the results
save(v03.submission01.S009, file=paste0(v03.dir,"/",out.rdata) )
write.csv(v03.submission01.S009, file=paste0(v03.dir,"/", out.csv), row.names=FALSE)
...
## output filenames
fit.id        <- "gbm_full_depth9_trees450_shrink0.05_V03_S010"
out.csv       <- paste0(fit.id,"_v03_Submission.csv")
out.rdata     <- paste0(fit.id,"_v03_Submission.Rdata")

## score -> class
thresh.S010            <- 0.810
v03.submission01.class <- ifelse(v03.submission01.mean.order >= thresh.S010, "s", "b")
v03.submission01.S010  <- data.frame(
EventId=v03.submission01.id.order,
RankOrder=v03.submission01.rank.order,
Class=v03.submission01.class)

## save the results
save(v03.submission01.S010, file=paste0(v03.dir,"/",out.rdata) )
write.csv(v03.submission01.S010, file=paste0(v03.dir,"/", out.csv), row.names=FALSE)
